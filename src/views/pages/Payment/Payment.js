...
import { HiClipboardList, HiCurrencyRupee, HiIdentification, HiSearch } from 'react-icons/hi'
...
const ReactTable = ({ columns, data }) => {
	...
	return (
        ...
        <div className="inline-flex flex-wrap xl:flex gap-rend justify-between  ml-4 " >
             ...
             <h4><HiCurrencyRupee/></h4>
            <h5 className="ml-3">Payment</h5>
            </div>
            <div className='inline-flex justify-between gap-rend'>
            <FilterInput
...
function Payment() {
	...
	return (
		<div>
			<ReactTable columns={columns} data={paymentData} />
		</div>
	)
}
