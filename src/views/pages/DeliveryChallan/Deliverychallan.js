...
import { DeliverychallanData } from '../data'
import {  HiClipboardList, HiCurrencyRupee,  HiSearch } from 'react-icons/hi'
...
const ReactTable = ({ columns, data }) => {
	...
	return (
        ...
        <div className="inline-flex flex-wrap xl:flex gap-rend justify-between  ml-4 " >
             ...
             <h4><HiClipboardList/></h4>
            <h5 className="ml-3"> Delivery Challan</h5>
            </div>
            <div className='inline-flex justify-between gap-rend'>
            <FilterInput
...
function Deliverychallan() {
	...
	return (
		<div>
			<ReactTable columns={columns} data={DeliverychallanData} />
		</div>
	)
}
